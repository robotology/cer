...
public:
    ...
    Transform(double Dx,double Dz,double Rx,double Rz)
    {
        ...
        R(0,0)=cRz;  R(0,1)=-sRz*cRx; R(0,2)= sRz*sRx; P.x=0.001*Dx*cRz;
        R(1,0)=sRz;  R(1,1)= cRz*cRx; R(1,2)=-cRz*sRx; P.y=0.001*Dx*sRz;
        R(2,0)=0.0;  R(2,1)=     sRx; R(2,2)=     cRx; P.z=0.001*Dz;
    }

    Transform(double Rx,double Ry,double Rz,double Px,double Py,double Pz) : R(Rx,Ry,Rz),P(0.001*Px,0.001*Py,0.001*Pz){}
