...
void RobotThread::run()
{
    ...
    T(1,0)= 0.0; T(1,1)= 1.0; T(1,2)= 0.0; T(1,3)=0.1*cos(0.40*2.0*M_PI*ti);//radius*sin(DEG2RAD*alfa);
    T(2,0)=-1.0; T(2,1)= 0.0; T(2,2)= 0.0; T(2,3)=0.1*sin(0.40*2.0*M_PI*ti);//0.7-0.63;
