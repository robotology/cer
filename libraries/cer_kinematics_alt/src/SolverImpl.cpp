    ...
    Wrot(3)
{
    ...
    // left arm
    {
        mLShoulder = new Component(Transform(-84,297.614,104.000002,180),mTorsoYaw);

        startLArm = id;
        mLshoulder0 = new Joint(id,-20,100,qmin,qmax,mLShoulder); mJoint[nj++] = (Joint*)mLshoulder0;
        mLshoulder0 = new Component(Transform(0,-175.204,90,90),mLshoulder0);
        mPart[4] = mLshoulder0;
    ...
    // right arm
    {
        mRShoulder = new Component(Transform(-84,297.614,75.999998,-180),mTorsoYaw);

        startRArm = id;
        mRshoulder0 = new Joint(id,-20,100,qmin,qmax,mRShoulder); mJoint[nj++] = (Joint*)mRshoulder0;
        mRshoulder0 = new Component(Transform(0,175.204,90,-90),mRshoulder0);
