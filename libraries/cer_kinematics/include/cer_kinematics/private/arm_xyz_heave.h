...
public:
    ...
    /****************************************************************/
    void set_zd1(const double zd)
    {
        zd1=zd;
    }

    /****************************************************************/
    void set_zd2(const double zd)
    {
        zd2=zd;
    }
                         ...
                         Ipopt::Index m, Ipopt::Number *g_l, Ipopt::Number *g_u)
    {
        ...
        g_l[0]=g_u[0]=0.0;
        g_l[1]=tripod1.cos_alpha_M; g_u[1]=1.0;

        g_l[2]=g_u[2]=0.0;
        g_l[3]=tripod2.cos_alpha_M; g_u[3]=1.0;
