...
/****************************************************************/
class ArmXyzNoTorsoHeaveNLP_ForwardDiff : public ArmCommonNLP
{
public:
    /****************************************************************/
    ArmXyzNoTorsoHeaveNLP_ForwardDiff(ArmSolver &slv_) : ArmCommonNLP(slv_)
    {
    }
...
/****************************************************************/
class ArmXyzNoTorsoHeaveNLP_CentralDiff : public ArmXyzNoTorsoHeaveNLP_ForwardDiff
{
public:
    /****************************************************************/
    ArmXyzNoTorsoHeaveNLP_CentralDiff(ArmSolver &slv_) :
        ArmXyzNoTorsoHeaveNLP_ForwardDiff(slv_)
    {
    }
