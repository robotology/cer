...
void IdleMotions::look_gripper()
{
    ...
    Time::delay(3.0);
    // double right_hand[2] = {85.0, 60.0};  m_iposctrl[4]->positionMove(right_hand); //right hand
    double right_arm1[8] = {41.7, 14.9, -40.6, 74.6, -33.8, 0.0, 6.1, 10.0}; m_iposctrl[0]->positionMove(right_arm1); //right arm
    Time::delay(2.0);
    // double right_hand1[2] = {25.0, 25.0};  m_iposctrl[4]->positionMove(right_hand1); //right hand
    double right_arm2[8] = {41.7, 14.9, -40.6, 74.6, 78.8, 0.0, 6.1, 10.0}; m_iposctrl[0]->positionMove(right_arm2); //right arm
    Time::delay(1.3);
    // double right_hand2[2] = {85.0, 60.0};  m_iposctrl[4]->positionMove(right_hand2); //right hand
    // Time::delay(1.3);
    // double right_hand3[2] = {25.0, 25.0};  m_iposctrl[4]->positionMove(right_hand3); //right hand
    Time::delay(2.0);
    go_home();
};
