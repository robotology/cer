...
#ifndef GAZEBOYARP_TRIPOD_HH
#define GAZEBOYARP_TRIPOD_HH
...
namespace gazebo
{
/// \class GazeboYarpTripod
/// Gazebo Plugin emulating the yarp tripod device in Gazebo.
///.
...
///
class GazeboYarpTripod : public ModelPlugin
{
public:
    GazeboYarpTripod();
    virtual ~GazeboYarpTripod();
